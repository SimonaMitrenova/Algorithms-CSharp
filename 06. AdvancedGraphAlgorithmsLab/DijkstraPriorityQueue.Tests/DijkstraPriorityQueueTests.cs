...
namespace DijkstraPriorityQueue.Tests
{
    ...
    public class DijkstraPriorityQueueTests
    {
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, 0, 9);
            var length = 0;
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, 0, 2);
            var length = 0;
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, 0, 10);
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, 0, 11);
            var length = 0;
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, 0, 1);
            var length = 0;
