...
namespace DijkstraPriorityQueue.Tests
{
    ...
    public class DijkstraPriorityQueueTests
    {
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, nodes[0], nodes[9]);
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, nodes[0], nodes[2]);
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, nodes[0], nodes[10]);
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, nodes[0], nodes[11]);
        ...
        {
            var path = Dijkstra.DijkstraAlgorithm(Graph, nodes[0], nodes[1]);
